...
PACKAGE_FILES = dist/python-hypothesis-0.3.0.tar.gz \
                dist/python_hypothesis-0.3.0-py2-none-any.whl \
                dist/python_hypothesis-0.3.0-py3-none-any.whl

build : $(PACKAGE_FILES)

dist/python-hypothesis-0.3.0.tar.gz : 
